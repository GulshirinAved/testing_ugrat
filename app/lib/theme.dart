...
ColorScheme _determineColorScheme(
  ...
  final colorScheme = switch (mode) {
    ColorMode.system => brightness == Brightness.light
        ? dynamicColors?.light
        : dynamicColors?.dark,
    ColorMode.localsend => (dynamicColors?.dark ?? defaultColorScheme).copyWith(
        background: Color.fromARGB(255, 163, 148, 160),
        surface: Color.fromARGB(255, 91, 75, 81),
        onPrimary: Color.fromARGB(255, 163, 148, 160)),
    ColorMode.oled => (dynamicColors?.dark ?? defaultColorScheme).copyWith(
        background: const Color.fromARGB(255, 60, 28, 39),
        surface: Color.fromARGB(255, 82, 30, 48),
      ),
  };
