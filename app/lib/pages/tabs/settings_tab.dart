  ...
  void initState() {
    ...
    ensureRef((ref) {
      ...
      _deviceModelController.text =
          ref.read(deviceInfoProvider).deviceModel ?? '';
                  ...
                  onChanged: (colorMode) async {
                    if (colorMode != null) {
                      ...
                      if (colorMode == ColorMode.oled) {
                        ...
                        await updateSystemOverlayStyleWithBrightness(
                            Brightness.dark);
                      }
                    }
                  },
                ...
                _BooleanEntry(
                  ...
                  onChanged: (b) async {
                    ...
                    if (await isLinuxLaunchAtStartEnabled()) {
                      ...
                      result =
                          await initEnableAutoStartAndOpenSettings(settings);
                    }
                    if (result) {
                      await ref
                          .notifier(settingsProvider)
...
>>>>>>> 04652670de171c2f8bb97e5321bc45a878a441e6
                _SettingsEntry(
                  label: t.settingsTab.general.color,
                  child: CustomDropdownButton<ColorMode>(
              ...
              if (_isWindows || _isLinux)
                Visibility(
                    ...
                    child: AnimatedOpacity(
                      opacity:
                          settings.launchAtStartup || _isWindows ? 1.0 : 0.0,
              ...
              _SettingsEntry(
                ...
                child: TextButton(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.symmetric(vertical: 5),
                    child: Text(
                        settings.destination ?? t.settingsTab.receive.downloads,
                        style: Theme.of(context).textTheme.titleMedium),
                  ),
                ),
              ),
...
<<<<<<< HEAD
            ...
            AnimatedCrossFade(
              crossFadeState: settings.multicastGroup != defaultMulticastGroup
                  ? CrossFadeState.showSecond
                  : CrossFadeState.showFirst,
              duration: const Duration(milliseconds: 200),
              alignment: Alignment.topLeft,
